...
import { UnprovenBlockModel, UnprovenBlockResolver, } from "./UnprovenBlockResolver";
...
export let BlockStorageResolver = class BlockStorageResolver extends GraphqlModule {
...
], BlockStorageResolver.prototype, "batches", null);
BlockStorageResolver = __decorate([
    graphqlModule(),
    __param(0, inject("BlockStorage")),
    __metadata("design:paramtypes", [Object, UnprovenBlockResolver])
