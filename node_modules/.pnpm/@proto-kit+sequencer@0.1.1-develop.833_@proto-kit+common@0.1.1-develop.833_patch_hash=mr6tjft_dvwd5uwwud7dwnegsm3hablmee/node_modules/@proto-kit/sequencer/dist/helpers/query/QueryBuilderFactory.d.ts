...
import { MandatoryProtocolModulesRecord, Protocol, ProtocolModule, ProtocolModulesRecord, State, StateMap } from "@proto-kit/protocol";
...
export type Query<ModuleType, ModuleRecord extends Record<string, TypedClass<ModuleType>>> = {
    [Key in keyof ModuleRecord]: ModuleQuery<InstanceType<ModuleRecord[Key]>>;
};
export declare const QueryBuilderFactory: {
    fillQuery<Module extends Object>(runtimeModule: Module, queryTransportModule: QueryTransportModule): ModuleQuery<Module>;
    ...
    fromProtocol<ProtocolModules extends MandatoryProtocolModulesRecord & ProtocolModulesRecord>(protocol: Protocol<ProtocolModules>, queryTransportModule: QueryTransportModule): Query<ProtocolModule<unknown>, ProtocolModules>;
};
