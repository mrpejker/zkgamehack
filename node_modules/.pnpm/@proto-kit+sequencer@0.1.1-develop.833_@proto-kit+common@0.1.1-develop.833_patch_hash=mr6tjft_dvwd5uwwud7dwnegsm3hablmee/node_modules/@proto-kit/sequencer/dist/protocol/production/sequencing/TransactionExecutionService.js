...
export let TransactionExecutionService = class TransactionExecutionService {
     ...
     */
    async createBlock(stateService, transactions, lastBlockWithResult, allowEmptyBlocks) {
        ...
        const previousBlockHash = lastResult.blockHash === 0n ? undefined : Field(lastResult.blockHash);
