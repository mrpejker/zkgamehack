...
export let UnprovenProducerModule = class UnprovenProducerModule extends SequencerModule {
    constructor(mempool, messageStorage, unprovenStateService, unprovenMerkleStore, blockQueue, blockTreeStore, executionService) {
        super();
    ...
    async tryProduceUnprovenBlock() {
        if (!this.productionInProgress) {
            try {
                ...
                const result = await this.executionService.generateMetadataForNextBlock(block, this.unprovenMerkleStore, this.blockTreeStore, true);
                return {
                    block,
                    result,
                };
