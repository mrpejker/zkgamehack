...
export declare function resolveMetadataItems({ tree, parentParams, metadataItems, errorMetadataItem, treePrefix, getDynamicParamFromSegment, searchParams, errorConvention, createDynamicallyTrackedParams, }: {
    tree: LoaderTree;
    parentParams: {
        [key: string]: any;
    };
...
export declare function resolveMetadata({ tree, parentParams, metadataItems, errorMetadataItem, getDynamicParamFromSegment, searchParams, errorConvention, metadataContext, createDynamicallyTrackedParams, }: {
    tree: LoaderTree;
    parentParams: {
        [key: string]: any;
    };
