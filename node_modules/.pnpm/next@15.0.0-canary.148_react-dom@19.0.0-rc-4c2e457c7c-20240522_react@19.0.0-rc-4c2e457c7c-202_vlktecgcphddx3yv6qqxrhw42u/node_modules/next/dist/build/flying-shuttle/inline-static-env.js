...
async function inlineStaticEnv({ distDir }) {
    const staticEnv = (0, _defineenvplugin.getNextPublicEnvironmentVariables)();
    ...
    for (const [parentDir, files] of [
        ...
        await Promise.all(files.map(async (file)=>{
            ...
            await _fs.default.promises.writeFile(filepath, content.replace(/[\w]{1,}\.env\.NEXT_PUBLIC_[\w]{1,}/g, (match)=>{
