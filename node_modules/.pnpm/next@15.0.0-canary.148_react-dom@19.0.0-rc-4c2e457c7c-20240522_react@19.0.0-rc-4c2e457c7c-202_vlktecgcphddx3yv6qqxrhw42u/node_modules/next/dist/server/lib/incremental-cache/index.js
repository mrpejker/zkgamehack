...
class IncrementalCache {
    constructor({ fs, dev, flushToDisk, fetchCache, minimalMode, serverDistDir, requestHeaders, requestProtocol, maxMemoryCacheSize, getPrerenderManifest, fetchCacheKeyPrefix, CurCacheHandler, allowedRevalidateHeaderKeys }){
   ...
   */ async lock(cacheKey) {
    ...
    async get(cacheKey, ctx) {
        ...
        if ((cacheData == null ? void 0 : cacheData.lastModified) === -1) {
            ...
            revalidateAfter = this.calculateRevalidate(cacheKey, (cacheData == null ? void 0 : cacheData.lastModified) || Date.now(), this.dev ? ctx.kind !== _responsecache.IncrementalCacheKind.FETCH : false, ctx.isFallback);
