...
async function createHotReloaderTurbopack(opts, serverFields, distDir, resetFetch) {
    var _opts_nextConfig_experimental_turbo, _opts_nextConfig_experimental_turbo1;
    const dev = true;
    ...
    const hotReloaderSpan = (0, _trace.trace)('hot-reloader', undefined, {
        version: "15.0.0-canary.148"
    });
    // Ensure the hotReloaderSpan is flushed immediately as it's the parentSpan for all processing
    // of the current `next dev` invocation.
    hotReloaderSpan.stop();
    const encryptionKey = await (0, _encryptionutils.generateEncryptionKeyBase64)(dev);
    // TODO: Implement
