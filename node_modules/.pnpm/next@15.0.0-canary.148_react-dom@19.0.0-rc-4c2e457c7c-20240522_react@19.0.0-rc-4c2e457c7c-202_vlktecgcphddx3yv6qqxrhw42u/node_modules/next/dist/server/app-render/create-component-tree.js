...
async function createComponentTreeInternal({ createSegmentPath, loaderTree: tree, parentParams, firstItem, rootLayoutIncluded, injectedCSS, injectedJS, injectedFontPreloadTags, getMetadataReady, ctx, missingSlots, preloadCallbacks }) {
   ...
   */ const rootLayoutIncludedAtThisLevelOrAbove = rootLayoutIncluded || rootLayoutAtThisLevel;
    ...
    if (typeof dynamic === 'string') {
        ...
        if (dynamic === 'error') {
            ...
            if (staticGenerationStore.isStaticGeneration && !experimental.isRoutePPREnabled) {
   ...
   */ let Component = LayoutOrPage;
    ...
    if (hasSlotKey && rootLayoutAtThisLevel && LayoutOrPage) {
        Component = (componentProps)=>{
            ...
            return /*#__PURE__*/ (0, _jsxruntime.jsx)(NotFoundBoundary, {
                notFound: NotFoundComponent ? /*#__PURE__*/ (0, _jsxruntime.jsxs)(Segment, {
    ...
    if (!Component) {
        return [
            actualSegment,
            /*#__PURE__*/ (0, _jsxruntime.jsxs)(Segment, {
                isStaticGeneration: isStaticGeneration,
                ready: getMetadataReady,
                children: [
                    layerAssets,
    ...
    // need to be dynamic
    if (staticGenerationStore.isStaticGeneration && staticGenerationStore.forceDynamic && experimental.isRoutePPREnabled) {
        return [
            actualSegment,
            /*#__PURE__*/ (0, _jsxruntime.jsxs)(Segment, {
                isStaticGeneration: isStaticGeneration,
    ...
    if (isPage) {
        ...
        if (isClientComponent) {
            ...
            pageElement = /*#__PURE__*/ (0, _jsxruntime.jsx)(Component, {
                ...props
            });
        }
        return [
...
async function Segment({ isStaticGeneration, ready, children }) {
