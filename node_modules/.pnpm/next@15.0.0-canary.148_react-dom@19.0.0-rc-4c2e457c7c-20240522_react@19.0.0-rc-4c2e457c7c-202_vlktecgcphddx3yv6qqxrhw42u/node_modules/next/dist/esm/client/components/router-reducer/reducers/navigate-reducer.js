...
import { addSearchParamsIfPageSegment, DEFAULT_SEGMENT_KEY } from '../../../../shared/lib/segment';
    ...
    return data.then((param)=>{
        ...
        for (const normalizedFlightData of flightData){
            ...
            if (prefetchValues.aliased) {
                treePatch[0] = addSearchParamsIfPageSegment(treePatch[0], Object.fromEntries(url.searchParams));
            }
