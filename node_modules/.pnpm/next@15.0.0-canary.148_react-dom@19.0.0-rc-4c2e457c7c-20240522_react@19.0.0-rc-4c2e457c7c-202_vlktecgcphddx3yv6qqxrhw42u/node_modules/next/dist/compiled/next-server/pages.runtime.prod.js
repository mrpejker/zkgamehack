...
`+i.join(" and ")+"\nSee more info here: https://nextjs.org/docs/messages/invalid-redirect-gssp")}async function e4(n,s,a,i,l,d){var u,c,p;let h,m,f,g;(0,b.gk)({req:n},"cookies",(c=n.headers,function(){let{cookie:e}=c;if(!e)return{};let{parse:t}=r("./dist/compiled/cookie/index.js");return t(Array.isArray(e)?e.join("; "):e)}));let v={};if(v.assetQueryString=l.dev&&l.assetQueryString||"",l.dev&&!v.assetQueryString){let e=(n.headers["user-agent"]||"").toLowerCase();e.includes("safari")&&!e.includes("chrome")&&(v.assetQueryString=`?ts=${Date.now()}`)}l.deploymentId&&(v.assetQueryString+=`${v.assetQueryString?"&":"?"}dpl=${l.deploymentId}`),i=Object.assign({},i);let{err:x,dev:S=!1,ampPath:w="",pageConfig:C={},buildManifest:E,reactLoadableManifest:T,ErrorDebug:L,getStaticProps:N,getStaticPaths:k,getServerSideProps:M,isNextDataRequest:D,params:F,previewProps:q,basePath:B,images:J,runtime:K,isExperimentalCompile:ee,swrDelta:er}=l,{App:ea}=d,ei=v.assetQueryString,el=d.Document,ed=l.Component,ep=!!i.__nextFallback,eh=i.__nextNotFoundSrcPage;!function(e){for(let t of eA)delete e[t]}(i);let em=!!N,ef=em&&l.nextExport,eg=ea.getInitialProps===ea.origGetInitialProps,ev=!!(null==ed?void 0:ed.getInitialProps),ey=null==ed?void 0:ed.unstable_scriptLoader,eb=G(a),ex="/_error"===a&&ed.getInitialProps===ed.origGetInitialProps;l.nextExport&&ev&&!ex&&t(`Detected getInitialProps on page '${a}' while running export. It's recommended to use getStaticProps which has a more correct behavior for static exporting.
Read more: https://nextjs.org/docs/messages/get-initial-props-export`);let eS=!ev&&eg&&!em&&!M;if(eS&&!S&&ee&&(s.setHeader("Cache-Control",function({revalidate:e,swrDelta:t}){let r=t?`stale-while-revalidate=${t}`:"stale-while-revalidate";return 0===e?"private, no-cache, no-store, max-age=0, must-revalidate":"number"==typeof e?`s-maxage=${e}, ${r}`:`s-maxage=${R.BR}, ${r}`}({revalidate:!1,swrDelta:er})),eS=!1),ev&&em)throw Error(R.wh+` ${a}`);if(ev&&M)throw Error(R.Wo+` ${a}`);if(M&&em)throw Error(R.oL+` ${a}`);if(M&&"export"===l.nextConfigOutput)throw Error('getServerSideProps cannot be used with "output: export". See more info here: https://nextjs.org/docs/advanced-features/static-html-export');if(k&&!eb)throw Error(`getStaticPaths is only allowed for dynamic SSG pages and was found on '${a}'.
Read more: https://nextjs.org/docs/messages/non-dynamic-getstaticpaths-usage`);if(k&&!em)throw Error(`getStaticPaths was added without a getStaticProps in ${a}. Without getStaticProps, getStaticPaths does nothing`);if(em&&eb&&!k)throw Error(`getStaticPaths is required for dynamic SSG pages and is missing for '${a}'.
Read more: https://nextjs.org/docs/messages/invalid-getstaticpaths-value`);let ew=l.resolvedAsPath||n.url;if(S){let{isValidElementType:e}=r("./dist/compiled/react-is/index.js");if(!e(ed))throw Error(`The default export is not a React Component in page: "${a}"`);if(!e(ea))throw Error('The default export is not a React Component in page: "/_app"');if(!e(el))throw Error('The default export is not a React Component in page: "/_document"');if((eS||ep)&&(i={...i.amp?{amp:i.amp}:{}},ew=`${a}${n.url.endsWith("/")&&"/"!==a&&!eb?"/":""}`,n.url=a),"/404"===a&&(ev||M))throw Error(`\`pages/404\` ${R.Ei}`);if(j.includes(a)&&(ev||M))throw Error(`\`pages${a}\` ${R.Ei}`)}for(let e of["getStaticProps","getServerSideProps","getStaticPaths"])if(null==ed?void 0:ed[e])throw Error(`page ${a} ${e} ${R.lk}`);await H.preloadAll(),(em||M)&&!ep&&q&&(f=!1!==(h=e(n,s,q,!!l.multiZoneDraftMode)));let eP=new eY(a,i,ew,{isFallback:ep},!!(M||ev||!eg&&!em||ee),B,l.locale,l.locales,l.defaultLocale,l.domainLocales,f,et(n,"isLocaleDomain")),e_={back(){eP.back()},forward(){eP.forward()},refresh(){eP.reload()},hmrRefresh(){},push(e,t){let{scroll:r}=void 0===t?{}:t;eP.push(e,void 0,{scroll:r})},replace(e,t){let{scroll:r}=void 0===t?{}:t;eP.replace(e,void 0,{scroll:r})},prefetch(e){eP.prefetch(e)}},eR={},eC=(0,_.createStyleRegistry)(),ej={ampFirst:!0===C.amp,hasQuery:!!i.amp,hybrid:"hybrid"===C.amp},eE=function(e){let{ampFirst:t=!1,hybrid:r=!1,hasQuery:n=!1}=void 0===e?{}:e;return t||r&&n}(ej),eN=function(e){void 0===e&&(e=!1);let t=[(0,y.jsx)("meta",{charSet:"utf-8"},"charset")];return e||t.push((0,y.jsx)("meta",{name:"viewport",content:"width=device-width"},"viewport")),t}(eE),eI=[],eM={};ey&&(eM.beforeInteractive=[].concat(ey()).filter(e=>"beforeInteractive"===e.props.strategy).map(e=>e.props));let eD=({children:e})=>(0,y.jsx)(ez.Provider,{value:e_,children:(0,y.jsx)(eO.Provider,{value:eP.isReady&&eP.query?new URL(eP.asPath,"http://n").searchParams:new URLSearchParams,children:(0,y.jsx)(eH,{router:eP,isAutoExport:eS,children:(0,y.jsx)(ek.Provider,{value:function(e){if(!e.isReady||!e.query)return null;let t={};for(let r of Object.keys(function(e){let{parameterizedRoute:t,groups:r}=function(e){let t=ec(e).slice(1).split("/"),r={},n=1;return{parameterizedRoute:t.map(e=>{let t=W.find(t=>e.startsWith(t)),o=e.match(eq);if(t&&o){let{key:e,optional:s,repeat:a}=eB(o[1]);return r[e]={pos:n++,repeat:a,optional:s},"/"+eF(t)+"([^/]+?)"}if(!o)return"/"+eF(e);{let{key:e,repeat:t,optional:s}=eB(o[1]);return r[e]={pos:n++,repeat:t,optional:s},t?s?"(?:/(.+?))?":"/(.+?)":"/([^/]+?)"}}).join(""),groups:r}}(e);return{re:RegExp("^"+t+"(?:/)?$"),groups:r}}(e.pathname).groups))t[r]=e.query[r];return t}(eP),children:(0,y.jsx)(z.Provider,{value:eP,children:(0,y.jsx)(A.Provider,{value:ej,children:(0,y.jsx)(O.Provider,{value:{updateHead:e=>{eN=e},updateScripts:e=>{eR=e},scripts:eM,mountedInstances:new Set},children:(0,y.jsx)(I.Provider,{value:e=>eI.push(e),children:(0,y.jsx)(_.StyleRegistry,{registry:eC,children:(0,y.jsx)(eL.Provider,{value:J,children:e})})})})})})})})})}),eU=()=>null,eW=({children:e})=>(0,y.jsxs)(y.Fragment,{children:[(0,y.jsx)(eU,{}),(0,y.jsx)(eD,{children:(0,y.jsxs)(y.Fragment,{children:[S?(0,y.jsxs)(y.Fragment,{children:[e,(0,y.jsx)(eU,{})]}):e,(0,y.jsx)(eU,{})]})})]}),eJ={err:x,req:eS?void 0:n,res:eS?void 0:s,pathname:a,query:i,asPath:ew,locale:l.locale,locales:l.locales,defaultLocale:l.defaultLocale,AppTree:e=>(0,y.jsx)(eW,{children:eK(ea,ed,{...e,router:eP})}),defaultGetInitialProps:async(e,t={})=>{let{html:r,head:n}=await e.renderPage({enhanceApp:e=>t=>(0,y.jsx)(e,{...t})}),o=eC.styles({nonce:t.nonce});return eC.flush(),{html:r,head:n,styles:o}}},eG=!em&&(l.nextExport||S&&(eS||ep)),eX=()=>{let e=eC.styles();return eC.flush(),(0,y.jsx)(y.Fragment,{children:e})};if(m=await X(ea,{AppTree:eJ.AppTree,Component:ed,router:eP,ctx:eJ}),(em||M)&&f&&(m.__N_PREVIEW=!0),em&&(m.__N_SSG=!0),em&&!ep){let e,t;try{e=await (0,eo.getTracer)().trace(es.xj.getStaticProps,{spanName:`getStaticProps ${a}`,attributes:{"next.route":a}},()=>N({...eb?{params:i}:void 0,...f?{draftMode:!0,preview:!0,previewData:h}:void 0,locales:l.locales,locale:l.locale,defaultLocale:l.defaultLocale,revalidateReason:l.isOnDemandRevalidate?"on-demand":ef?"build":"stale"}))}catch(e){throw e&&"ENOENT"===e.code&&delete e.code,e}if(null==e)throw Error(R.q6);let r=Object.keys(e).filter(e=>"revalidate"!==e&&"props"!==e&&"redirect"!==e&&"notFound"!==e);if(r.includes("unstable_revalidate"))throw Error(R.Eo);if(r.length)throw Error(e0("getStaticProps",r));if("notFound"in e&&e.notFound){if("/404"===a)throw Error('The /404 page can not return notFound in "getStaticProps", please remove it to continue!');v.isNotFound=!0}if("redirect"in e&&e.redirect&&"object"==typeof e.redirect){if(e1(e.redirect,n,"getStaticProps"),ef)throw Error(`\`redirect\` can not be returned from getStaticProps during prerendering (${n.url})
See more info here: https://nextjs.org/docs/messages/gsp-redirect-during-prerender`);e.props={__N_REDIRECT:e.redirect.destination,__N_REDIRECT_STATUS:en(e.redirect)},void 0!==e.redirect.basePath&&(e.props.__N_REDIRECT_BASE_PATH=e.redirect.basePath),v.isRedirect=!0}if((S||ef)&&!v.isNotFound&&!$(a,"getStaticProps",e.props))throw Error("invariant: getStaticProps did not return valid props. Please report this.");if("revalidate"in e){if(e.revalidate&&"export"===l.nextConfigOutput)throw Error('ISR cannot be used with "output: export". See more info here: https://nextjs.org/docs/advanced-features/static-html-export');if("number"==typeof e.revalidate){if(Number.isInteger(e.revalidate)){if(e.revalidate<=0)throw Error(`A page's revalidate option can not be less than or equal to zero for ${n.url}. A revalidate option of zero means to revalidate after _every_ request, and implies stale data cannot be tolerated.
