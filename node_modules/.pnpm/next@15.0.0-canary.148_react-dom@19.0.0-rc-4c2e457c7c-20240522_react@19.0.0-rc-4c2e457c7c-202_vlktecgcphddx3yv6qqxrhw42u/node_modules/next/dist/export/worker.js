...
async function exportPageImpl(input, fileWriter) {
    ...
    try {
        ...
        if (isAppDir && (0, _isapprouteroute.isAppRouteRoute)(page)) {
            return await (0, _approute.exportAppRoute)(req, res, params, page, input.renderOpts.incrementalCache, distDir, htmlFilepath, fileWriter, input.renderOpts.experimental);
        }
